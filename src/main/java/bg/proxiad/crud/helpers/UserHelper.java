...
public class UserHelper {
  ...
  public boolean checkUserInput(
      HttpServletRequest req, @ModelAttribute("userInfo") UserModel userInfo) {
  ...
  public void updatePassword(
    ...
    Map<String, String> mapUsersUpdate = (Map<String, String>) getUserMap(req);
  ...
  public void deleteUser(HttpServletRequest req) {
    ...
    Map<String, String> mapUsersDelete = (Map<String, String>) getUserMap(req);
    mapUsersDelete.remove(query);
    getSession(req).setAttribute("userMap", mapUsersDelete);
  }

  public void registerUser(@ModelAttribute("userInfo") UserModel userInfo, HttpServletRequest req) {
